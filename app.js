...
function buildRainloggerQuery1() {
    ...
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
     + " rainlogger  WHERE dateTime > now() - INTERVAL 7 day  GROUP BY dateTime ORDER BY dateTime ASC;";
}
...
function buildLeveloggerQuery1() {
    ...
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
     + " levelogger WHERE dateTime > now() - INTERVAL 7 day GROUP BY dateTime ORDER BY dateTime ASC;";
}

function buildRainloggerQuery2() {
    //return "SELECT *, DATE_FORMAT(date, '%Y-%m-%d') AS date, TIME_FORMAT(time, '%h:%i %p') AS time FROM rainlogger;";
    //    return "SELECT *, DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
    //     + " rainlogger  WHERE dateTime > now() - INTERVAL 30 day  GROUP BY YEAR(dateTime), MONTH(dateTime), DAY(dateTime)"
    //     + " ORDER BY dateTime;";
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
     + " rainlogger  WHERE dateTime > now() - INTERVAL 30 day  GROUP BY dateTime ORDER BY dateTime ASC;";
}

function buildLeveloggerQuery2() {
    //return "SELECT *, DATE_FORMAT(date, '%Y-%m-%d') AS date, TIME_FORMAT(time, '%h:%i %p') AS time FROM levelogger;";
    //    return "SELECT *, DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
    //    + " levelogger WHERE dateTime > now() - INTERVAL 30 day GROUP BY YEAR(dateTime), MONTH(dateTime), DAY(dateTime)"
    //    + " ORDER BY dateTime;";
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
    + " levelogger WHERE dateTime > now() - INTERVAL 30 day GROUP BY dateTime ORDER BY dateTime ASC;";
}

function buildRainloggerQuery3() {
    //return "SELECT *, DATE_FORMAT(date, '%Y-%m-%d') AS date, TIME_FORMAT(time, '%h:%i %p') AS time FROM rainlogger;";
    //    return "SELECT *, DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
    //     + " rainlogger  WHERE dateTime > now() - INTERVAL 60 day  GROUP BY YEAR(dateTime), MONTH(dateTime), DAY(dateTime)"
    //     + " ORDER BY dateTime;";
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
     + " rainlogger  WHERE dateTime > now() - INTERVAL 60 day  GROUP BY dateTime ORDER BY dateTime ASC;";
}

function buildLeveloggerQuery3() {
    //return "SELECT *, DATE_FORMAT(date, '%Y-%m-%d') AS date, TIME_FORMAT(time, '%h:%i %p') AS time FROM levelogger;";
    //    return "SELECT *, DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
    //     + " levelogger WHERE dateTime > now() - INTERVAL 60 day GROUP BY YEAR(dateTime), MONTH(dateTime), DAY(dateTime)"
    //     + " ORDER BY dateTime;";
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
     + " levelogger WHERE dateTime > now() - INTERVAL 60 day GROUP BY dateTime ORDER BY dateTime ASC;";
}
function buildRainloggerQuery4() {
    //return "SELECT *, DATE_FORMAT(date, '%Y-%m-%d') AS date, TIME_FORMAT(time, '%h:%i %p') AS time FROM rainlogger;";
    //    return "SELECT *, DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
    //     + " rainlogger  WHERE dateTime > now() - INTERVAL 365 day  GROUP BY YEAR(dateTime), MONTH(dateTime), DAY(dateTime)"
    //     + " ORDER BY dateTime;";
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
     + " rainlogger  WHERE dateTime > now() - INTERVAL 365 day  GROUP BY dateTime ORDER BY dateTime ASC;";
}

function buildLeveloggerQuery4() {
    //return "SELECT *, DATE_FORMAT(date, '%Y-%m-%d') AS date, TIME_FORMAT(time, '%h:%i %p') AS time FROM levelogger;";
    //    return "SELECT *, DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
    //     + " levelogger WHERE dateTime > now() - INTERVAL 365 day GROUP BY YEAR(dateTime), MONTH(dateTime), DAY(dateTime)"
    //     + " ORDER BY dateTime;";
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
     + " levelogger WHERE dateTime > now() - INTERVAL 365 day GROUP BY dateTime ORDER BY dateTime ASC;";
}
function buildRainloggerQuery5() {
    //return "SELECT *, DATE_FORMAT(date, '%Y-%m-%d') AS date, TIME_FORMAT(time, '%h:%i %p') AS time FROM rainlogger;";
    //    return "SELECT *, DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
    //     + " rainlogger GROUP BY YEAR(dateTime), MONTH(dateTime), DAY(dateTime) ORDER BY dateTime;";
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, SUM(rainFallInMilliMeters) AS 'total' FROM"
     + " rainlogger GROUP BY dateTime ORDER BY dateTime ASC;";
}

function buildLeveloggerQuery5() {
    //return "SELECT *, DATE_FORMAT(date, '%Y-%m-%d') AS date, TIME_FORMAT(time, '%h:%i %p') AS time FROM levelogger;";
    //    return "SELECT *, DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
    //     + " levelogger GROUP BY YEAR(dateTime), MONTH(dateTime), DAY(dateTime) ORDER BY dateTime;";
    return "SELECT DATE_FORMAT(dateTime, '%m/%d/%Y %h:%i%p') AS dateTime, AVG(levelInMeters) AS 'average' FROM"
     + " levelogger GROUP BY dateTime ORDER BY dateTime ASC;";
}
