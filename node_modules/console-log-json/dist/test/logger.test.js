  ...
  "attachments": [
    ...
    },
    {
     ...
     `;
        ...
        console.log(outputText[0]);
        (0, chai_1.expect)(JSON.parse(outputText[0]).level).eql("info");
        (0, chai_1.expect)(JSON.parse(outputText[0])["@autoParsedJson"]).eql({ "attachments": [{ "color": "#0062FF", "fields": [{ "title": "# of SDs for READY state update", "value": "56" }, { "title": "PDF_VERIFIED => READY", "value": "56" }], "author_name": "DSP Conversion Runner" }, { "color": "#DA1E28", "fields": [{ "title": "# of SDs failed to update state", "value": "0" }], "author_name": "DSP Conversion Runner" }] });
    });
